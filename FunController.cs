    ...
    class FunController
    {
        ...
        public virtual void processSkeletonFrame(SkeletonData skeleton, Dictionary<int, Target> targets)
        {
            ...
            foreach (var target in targets)
            {
                ...
                Joint leftHand = skeleton.Joints[JointID.HandLeft].ScaleTo(640, 480, k_xMaxJointScale, k_yMaxJointScale);
                Joint rightHand = skeleton.Joints[JointID.HandRight].ScaleTo(640, 480, k_xMaxJointScale, k_yMaxJointScale);
        ...
        //directly move the targets in the Mainxaml file to achieve the same initial repositioning.
        ...
        //position the ellipses in the Mainxaml.cs file.
